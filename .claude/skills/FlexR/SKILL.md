...
name: FlexR
description: |
  My Style System の FlexR コンポーネントを生成するスキル。ユーザーが「FlexR」「FlexR」「/FlexR」「比率割付」「2 分割」「2 種類コンテンツ比率」などと言った場合、または 2 種類のコンテンツを比率で配置する必要がある時に使用。
...
このスキルは My Style System の FlexR コンポーネントを生成・実装します。
