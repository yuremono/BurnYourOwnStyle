			...
			<div className=" ">
				...
				<section className=" wrapper into bg-blue-900 text-white">
					...
					>
						...
						<Item>
							<div className="p-6">
								...
								<p className="  leading-[2.77] text-center mb-6">
									不動産（土地・建物）の相続登記、戸籍・住民票など相続関係書類の収集、遺産分割協議書作成、名義変更（登記申請）手続き、相続人調査など幅広く対応しています。
								</p>
						...
						<Item>
							<div className="p-6">
								<figure className="w-[247px] h-[124px]  mb-6">
									<svg viewBox="0 0 247 124" className="w-full h-full">
										<path d="M0 0l439.94998 0 0 179.75999-439.94998 0 0-179.75999z" fill="#90e0e3" transform="scale(0.5) translate(-50, -50)"/>
										<path d="M443.94998 187.75999l-63.46997 0c-2.20999 0-4-1.78999-4-4 0-2.21 1.79001-4 4-4l59.46997 0 0-171.75999-431.94998 0 0 171.75999 351.41998 0c2.20999 0 4 1.79 4 4 0 2.21001-1.79001 4-4 4l-355.41998 0c-2.21 0-4-1.78999-4-4l0-179.75999c0-2.21 1.79-4 4-4l439.94998 0c2.20999 0 4 1.79 4 4l0 179.75999c0 2.21001-1.79001 4-4 4z" fill="#30caca" transform="scale(0.5) translate(-50, -50)"/>
									</svg>
								</figure>
								<h3 className="   text-center mb-4">
									相続放棄
								...
								<p className="  leading-[2.77] text-center mb-6">
									単純承認、限定承認、相続放棄の選択肢判断、家庭裁判所への申述手続き、期限届满対応、他相続人との連絡調整など対応しています。
								</p>
								<div className="flex justify-center">
									<button className="border border-white/60 rounded-full px-10 py-3   hover:bg-white/10 transition-colors">
										相続放棄について
				...
				<section className="wrapper">
					...
					<Cards className="col4 IsLayer" style={{ } as React.CSSProperties}>
						...
						<Item image="https://picsum.photos/401/401">
							<div>
								<h3>タイトル 2</h3>
								<p>説明文 2</p>
							</div>
						</Item>
						<Item image="https://picsum.photos/402/402">
							<div>
								<h3>タイトル 3</h3>
								<p>説明文 3</p>
							</div>
						</Item>
						<Item image="https://picsum.photos/403/403">
							<div>
								<h3>タイトル 4</h3>
								<p>説明文 4</p>
							</div>
