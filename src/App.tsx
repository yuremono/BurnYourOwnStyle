		...
		<main className="">
			...
			<section className="">
				...
				<Cards className="col3 IsIcon img1-1">
					<CardsItem image={getAssetPath("/images/picsum/004.jpg")}>
					...
					<CardsItem image={getAssetPath("/images/picsum/005.jpg")}>
					...
					<CardsItem image={getAssetPath("/images/picsum/006.jpg")}>
			...
			<section className="wrapper">
				...
				<Cards className="col4 IsLayer">
					<CardsItem image={getAssetPath("/images/picsum/007.jpg")}>
						<h3>タイトル 1</h3>
						<p>説明文 1</p>
					</CardsItem>
					<CardsItem image={getAssetPath("/images/picsum/008.jpg")}>
						<h3>タイトル 2</h3>
						<p>説明文 2</p>
					</CardsItem>
					<CardsItem image={getAssetPath("/images/picsum/009.jpg")}>
						<h3>タイトル 3</h3>
						<p>説明文 3</p>
					</CardsItem>
					<CardsItem image={getAssetPath("/images/picsum/010.jpg")}>
						<h3>タイトル 4</h3>
						<p>説明文 4</p>
					</CardsItem>
				</Cards>
			...
			<section>
				...
				<Panel className="img40 IsFlow">
					<PanelItem image={getAssetPath("/images/picsum/013.jpg")}>
					...
					<PanelItem image={getAssetPath("/images/picsum/015.jpg")}>
			...
			>
				...
				>
					<CardsItem image={getAssetPath("/images/picsum/018.jpg")}>
						<h3 className="text-white">タイトル A</h3>
						<p className="text-white/80">説明文 A</p>
					</CardsItem>
					<CardsItem image={getAssetPath("/images/picsum/019.jpg")}>
						<h3 className="text-white">タイトル B</h3>
						<p className="text-white/80">説明文 B</p>
					</CardsItem>
					<CardsItem image={getAssetPath("/images/picsum/020.jpg")}>
			...
			<section className=" ">
				...
				<Cards className=" IsFix">
					<CardsItem image={getAssetPath("/images/picsum/002.jpg")}>
						<h3>カード 1</h3>
						<p>説明文</p>
					</CardsItem>
					<CardsItem image={getAssetPath("/images/picsum/004.jpg")}>
