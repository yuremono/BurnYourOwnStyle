...
function Test2() {
	...
	return (
		<>
			...
			<main id="" className="test2Page min-h-screen  mt-[var(--head)]">
				...
				>
					...
					>
						...
						{/* <RgbShift
							className="StickItem sticky min-h-[100lvh] content-center"
							ariaLabel="p-1.svg 抜粋（st0 1パス・Illustrator 座標系）"
						>
							<svg
								className=""
				...
				{/* modules demo */}
				<section className="wrapper max-w-3xl mx-auto px-4 py-12 space-y-8  title1">
					<h2 className="text-xl font-bold">
						BYOS runtime（Budoux / SpanWrap / ScrollX / Video）
					</h2>
			...
			{/* Footer */}
			<footer className="wrapper into bg-slate-950  py-12">
